...
const mockEvents: EventTicketing[] = [
  {
    ...
    description: 'Join industry experts and researchers for a comprehensive exploration of the latest trends in AI and ML.',
    type: 'conference',
    organizerId: 'org-1',
    ...
    venue: {
      type: 'physical',
      address: 'Tech Convention Center, Bangalore',
    ...
    ticketTypes: [
      {
        id: 'early-bird',
        name: 'Early Bird',
        description: 'Limited time offer with 30% discount',
        price: 1750,
        totalAvailable: 100,
        sold: 45,
        maxPerPerson: 2,
        saleStartDate: new Date('2024-10-01'),
        saleEndDate: new Date('2024-11-15'),
        benefits: ['Priority seating', 'Welcome kit', 'Networking lunch', 'Certificate'],
        color: '#22c55e'
      },
      {
        id: 'regular',
        ...
        saleEndDate: new Date('2024-12-10'),
        benefits: ['Access to all sessions', 'Welcome kit', 'Certificate'],
        color: '#3b82f6'
      },
      {
        id: 'vip',
        ...
        saleStartDate: new Date('2024-10-01'),
        saleEndDate: new Date('2024-12-10'),
        benefits: ['Front row seating', 'Premium welcome kit', 'VIP networking dinner', 'One-on-one sessions', 'Certificate'],
        color: '#f59e0b'
      }
    ],
    totalCapacity: 450,
    ...
    refundPolicy: {
      allowRefunds: true,
      refundDeadline: new Date('2024-12-10'),
      refundPercentage: 80,
      processingFee: 50,
      refundableTicketTypes: ['regular', 'vip']
    },
    eventOrganizer: {
      id: 'org-1',
      name: 'TechEvents India',
      email: 'contact@techevents.in',
      company: 'TechEvents Private Limited',
      description: 'Leading organizer of technology conferences in India',
