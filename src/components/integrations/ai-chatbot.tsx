...
export default function AIChatbot({ 
  ...
  const addWelcomeMessage = () => {
    const welcomeMessage: ChatMessage = {
      ...
      type: 'assistant',
      content: `Hello! I'm your CIS-SAP AI Assistant. I can help you with:
...
${eventTitle ? `I see you're working with "${eventTitle}". ` : ''}What would you like to know?`,
  ...
  const exportChat = () => {
    ...
    a.href = url;
    a.download = `cis-sap-chat-${new Date().toISOString().split('T')[0]}.txt`;
        ...
        <CardContent className="p-0">
          ...
          <div className="border-t p-4">
            <div className="flex gap-2">
              <Textarea
                ref={inputRef}
                placeholder="Ask me anything about CIS-SAP..."
                value={inputMessage}
