...
export function MatchmakingCard({ match, onConnect }: MatchmakingCardProps) {
  return (
    <Card className="bg-muted/40 border-border hover:border-primary/50 transition-all duration-300 group overflow-hidden">
      <CardContent className="p-6">
          ...
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              <div className="absolute -bottom-1 -right-1 bg-background rounded-full p-1 border border-border">
                <div className="bg-primary rounded-full h-3 w-3" />
              </div>
            </div>
            <div>
              <h3 className="font-bold text-lg text-white group-hover:text-primary transition-colors">{match.name}</h3>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {match.conversationStarters.slice(0, 2).map((starter, i) => (
              <div key={i} className="text-xs bg-muted/40 p-2 rounded-lg border border-border/60 text-muted-foreground line-clamp-1">
                "{starter}"
              </div>
            ))}
          </div>
        ...
        <div className="flex gap-2 mt-6">
          ...
          <Button variant="outline" className="border-border hover:bg-muted/40 text-white">
