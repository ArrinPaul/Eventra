    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl text-foreground space-y-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <Badge className="bg-primary/10 text-primary border-cyan-500/20 px-3 py-1 mb-2">
            <Brain className="w-3 h-3 mr-2" />
            Advanced AI Matchmaking
          </Badge>
          <h1 className="text-4xl font-extrabold tracking-tight">Personalized Matchmaking</h1>
          <p className="text-muted-foreground text-lg">Our AI analyzes your profile and goals to find your perfect professional matches.</p>
        </div>
        <div className="flex items-center gap-3">
          <Link href="/networking">
            <Button className="bg-muted hover:bg-white/20 text-foreground">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-6 rounded-xl border border-border bg-card p-4 text-sm text-foreground/80">
