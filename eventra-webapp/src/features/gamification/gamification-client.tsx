    ...
    <div className="container mx-auto px-4 py-6 text-white space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-4">
          <Card className="bg-muted/40 border-border text-white min-w-[150px]">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="bg-muted/40 border-border text-white">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-muted/40 border-border text-white md:col-span-2">
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-4">
                  {pointsHistory.slice(0, 5).map((entry: any) => (
                    <div key={entry._id} className="flex items-center justify-between p-3 bg-muted/40 rounded-lg border border-border">
        ...
        <TabsContent value="badges">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {badgeDefinitions.map((badge: any) => {
              ...
              return (
                <Card key={badge._id} className={cn("bg-muted/40 border-border text-white transition-all hover:scale-105", !isEarned && "opacity-40 grayscale")}>
