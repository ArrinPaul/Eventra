...
export function ReportGenerator({ eventId, eventTitle }: ReportGeneratorProps) {
  ...
  return (
    <Card className="bg-gradient-to-br from-cyan-600/20 to-blue-600/20 border-border text-foreground overflow-hidden">
      <CardHeader>
      ...
      <CardContent>
         <ul className="space-y-2 mb-6">
           <li className="flex items-center gap-2 text-sm text-cyan-50/80"><CheckCircle2 size={14} className="text-primary" /> Executive summary of attendance</li>
           <li className="flex items-center gap-2 text-sm text-cyan-50/80"><CheckCircle2 size={14} className="text-primary" /> Sentiment analysis of feedback</li>
           <li className="flex items-center gap-2 text-sm text-cyan-50/80"><CheckCircle2 size={14} className="text-primary" /> Key highlights and areas for growth</li>
         </ul>
         <Button 
