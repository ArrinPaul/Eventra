      ...
      <CardContent className="space-y-6">
        ...
        {webhooks.length > 0 && (
          <div className="space-y-3 pt-4 border-t border-border">
            ...
            <div className="space-y-2">
              {webhooks.map((w) => (
                <div key={w.id} className="p-3 rounded-lg border border-border bg-card text-xs">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <Button 
                      variant="ghost" 
                      size="icon" 
                      className="h-6 w-6 text-destructive hover:bg-red-400/10"
                      onClick={async () => {
                  ...
                  <div className="flex items-center gap-2 mt-3 text-[10px] text-muted-foreground pt-2 border-t border-border/50">
