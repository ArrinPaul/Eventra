        ...
        <Card className="bg-card border-border text-foreground overflow-hidden flex flex-col">
          ...
          <CardContent className="flex-1 flex flex-col justify-center gap-8">
            <div className="flex justify-around items-center text-center">
              ...
              <div className="space-y-2">
                <div className="p-3 bg-destructive/10 rounded-full mx-auto w-fit"><Frown className="text-destructive" size={32} /></div>
        ...
        <CardContent>
          <div className="space-y-4">
            {analytics.feedbackList.slice(0, 5).map((f, i) => (
              <div key={i} className="p-4 bg-card rounded-lg border border-border/50 flex gap-4">
                ...
                <div>
                  <p className="text-sm italic text-foreground/80">"{f.comment || 'No comment provided'}"</p>
