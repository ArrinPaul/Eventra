  ...
  return (
    <div className="space-y-8 text-foreground">
      <div>
        ...
        <p className="text-muted-foreground">Insights and attendee satisfaction for <span className="text-foreground font-bold">{eventTitle}</span></p>
      </div>
        ...
        <CardContent>
           <div className="space-y-4">
              {feedbackList.map((feedback) => (
                <div key={feedback.id} className="p-4 rounded-xl bg-card border border-border/50 space-y-3">
