  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'premium': '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 10px 20px -5px rgba(0, 0, 0, 0.1), 0 20px 40px -10px rgba(0, 0, 0, 0.1)',
        'glow-red': '0 0 20px rgba(229, 57, 53, 0.25), 0 8px 32px rgba(229, 57, 53, 0.15)',
        'glow-blue': '0 0 20px rgba(59, 130, 246, 0.25), 0 8px 32px rgba(59, 130, 246, 0.15)',
      },
      borderRadius: {
        lg: 'var(--radius)',
